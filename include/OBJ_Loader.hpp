#ifndef SUBMODULES_OBJ_LOADER
#define SUBMODULES_OBJ_LOADER
...
// Some changed made only for mtt:
/*
    all functions not class member function are set as inline,
    to avoid compile duplicate symbols.
*/
